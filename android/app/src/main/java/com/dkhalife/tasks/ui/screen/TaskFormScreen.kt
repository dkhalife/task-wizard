    ...
    Scaffold(
        ...
        bottomBar = {
            Card(
                ...
                Button(
                    ...
                    Text(
                        if (isEditing) "Update Task" else "Create Task",
        ...
        Column(
            ...
            if (availableLabels.isNotEmpty()) {
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        SectionHeader(Icons.AutoMirrored.Filled.Label, "Labels")
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    SectionHeader(Icons.Default.CalendarToday, "Due Date")
                    Spacer(modifier = Modifier.height(8.dp))
                    Row(
                        modifier = Modifier.fillMaxWidth(),
            ...
            AnimatedVisibility(
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        SectionHeader(Icons.Default.Repeat, "Repeat")
                        Spacer(modifier = Modifier.height(8.dp))
                        RecurrenceSection(
