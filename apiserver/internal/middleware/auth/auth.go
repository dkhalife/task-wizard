...
type EntraAuthMiddleware struct {
	TenantID     string
	Audience     string
...
func NewEntraAuthMiddleware(cfg *config.Config, uRepo repos.IUserRepo) *EntraAuthMiddleware {
...
func (m *EntraAuthMiddleware) MiddlewareFunc() gin.HandlerFunc {
