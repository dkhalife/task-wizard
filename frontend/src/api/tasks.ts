...
export const GetCompletedTasks = async (limit: number = 10, page: number = 1): Promise<TasksResponse> =>
  await Request<TasksResponse>(`/tasks/completed?limit=${limit}&page=${page}`)
